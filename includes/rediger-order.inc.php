...
$OPris = (isset($_POST['OPris']) ? $_POST['OPris'] : null);
...
if (empty($OPic1)) {
	header("Location: ../rediger-order.php?error=empty");
	exit();
}
...
*/
	...
	$sql = "UPDATE ordrer SET Ordrer_Billede1='$OPic1', Ordrer_Billede2='$OPic2', Ordrer_Billede3='$OPic3', Ordrer_Billede4='$OPic4', Ordrer_Billede5='$OPic5', Ordrer_Startdato='$OStart', Ordrer_Slutdato='$OSlut', Ordrer_SamletPris='$OPris', profiler_idprofiler='$Kid' WHERE idOrdrer='$Oid'";
	$conn->query($sql);
